namespace NServiceBus.Gateway.AcceptanceTests
{
    ...
    public class When_doing_request_reply : NServiceBusAcceptanceTest
    {
        ...
        public class SiteAWithProxy : EndpointConfigurationBuilder
        {
            public SiteAWithProxy()
            {
                EndpointSetup<GatewayEndpoint>(c =>
                    {
                        ...
                        gatewaySettings.AddReceiveChannel("http://+:25699/SiteA/", "http", 10, true, "http://localhost:25699/SiteA/");
